...
<CardGrid stagger>
  ...
  <Card title="Project" icon="rocket">
    Project milestones are organized in a series of monthly goals for the overaching goal of developing and distributing an Android application, starting with [Milestone 1][m1].
  </Card>
</CardGrid>
