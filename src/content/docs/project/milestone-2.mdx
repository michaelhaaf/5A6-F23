...
We will add more workflows in future milestones.
...
[See this table here](https://student.cs.uwaterloo.ca/~cs346/1231/getting-started/gitlab/index.html#project-tracking) for an overview of how you will use GitHub to create you project proposal. More detail to come.
