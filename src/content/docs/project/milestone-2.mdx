...
[See this table here](https://student.cs.uwaterloo.ca/~cs346/1231/getting-started/gitlab/index.html#project-tracking) for an overview of how you will use GitHub to create your project proposal. 

The [lecture notes on Application Development](/5A6-F23/lectures/development/02-software-process/) contain slides that specify the requirements for this part of the milestone.
