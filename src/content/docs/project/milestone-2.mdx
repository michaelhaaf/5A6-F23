...
By the end of this milestone, you will have done the following:
  ...
  - **Sprint 2:** Propose and scope your project:
    ...
    - Determine what features to implement, publish a road map for implementing them, and plan for contingencies and how they interact *(roadmap, risk analysis)*.
...
This milestone kicks off your project by having you complete two discrete tasks. Instructions and specific requirements are given in the sections below.
  ...
  - **(Oct 6)** Create a group repository to track contributions, store documentation, and marshall required project infrastructure for automated CI/CD throughout the semester
...
- Make the repository **private**. **Add yourself your team members and myself (michaelhaaf) as collaborators** to this project.
- Initialize with a `README.md` file, and see below for suggestions on formatting and contents.
- [Choose a license](https://choosealicense.com/). **Instructions will be clarified in a future version of this milestone**

Your README can and will be updated throughout the semester. By Sprint 1, it should adhere to the following template:

```markdown title="README.md"
# PROJECT NAME

## Goal
A brief description of your application. Should answer, as concisely as you can: what is it? what is it's purpose?

## Quick-start
How to install and launch your application from source code
...
version 0.1.0: released Oct 6th, 2023
	* [link to release-notes (txt or md)]

(future releases will follow below, using sematic versioning conventions: version X.Y.Z) 
