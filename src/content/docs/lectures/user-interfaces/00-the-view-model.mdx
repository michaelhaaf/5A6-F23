...
You shouldn't need to memorize anything here -- I will refer to these notes in subsequent lessons if we need to compare these concepts with modern Compose methods.
