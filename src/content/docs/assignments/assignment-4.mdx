---
title: "Module 4: Advanced Android Development Techniques"
description: "In this assignment we continue learning techniques in application architecture for the Android stack, in particular accessibility and coroutines. We will continue to document our progress through codelabs using git/GitHub best practises to keep track of the techiques learned and to practise useful repository management skills."
sidebar:
  hidden: false
---
...
For this assignment, you will pick up two important Jetpack Compose / Android Architecture techniques (Accessibility and Coroutines) from the Android compose labs. You will also practise maintaining legible development history using git and GitHub.
