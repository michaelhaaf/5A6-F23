...
[lecture-viewmodel]: /5A6-F23/lectures/user-interfaces/05-data-flow
[lecture-datastore]: /5A6-F23/lectures/user-interfaces/06-data-persistence
[lecture-accessibility]: /5A6-F23/lectures/user-interfaces/07-accessibility
[lecture-advanced-kotlin]: /5A6-F23/lectures/programming/04-advanced-kotlin
[lecture-coroutines]: /5A6-F23/lectures/programming/05-coroutines
...
[codelab-coroutines-1]: https://developer.android.com/codelabs/basic-android-kotlin-compose-coroutines-kotlin-playground#0
[codelab-coroutines-2]: https://developer.android.com/codelabs/basic-android-kotlin-compose-coroutines-android-studio#0
...
- (Required): [Using Datastore for data persistence][codelab-datastore] (~30mins)
  - Link to starter code: [Datastore starter code .zip](https://github.com/android/codelab-android-datastore/archive/master.zip)
- (Required): choose **one** of the following codelabs:[^2]
  - [Starting Android Accessibility][codelab-accessibility] (~15mins). 
    - Shorter and simpler, but uses the old View model (and not Jetpack Compose)
    - [Link to starter code .zip](/5A6-F23/code/Counter.zip)
  - [Accessibility in Jetpack Compose][codelab-accessibility-2] (~40mins). 
    - A bit longer, but directly applies to Jetpack Compose. 
    - [Link to starter code .zip](https://github.com/android/codelab-android-compose/archive/refs/heads/main.zip)
- (Option 1): Complete all three of the following (~45 mins total). No starter code, just follow assignment instructions:
  - [Kotlin bootcamp: Extensions][kt-bootcamp-51]
  - [Kotlin bootcamp: Generics][kt-bootcamp-52]
  - [Kotlin bootcamp: Functional Manipulation][kt-bootcamp-6]
- (Option 2): Complete both of the following (~45 mins total). For starter code, click "Download Zip" in the instruction set:
...
- (36, 12 per codelab) An **open pull request**[^1] from each development branch to `main`

[^1]: Note: you shouldn't merge these pull requests into main. Keep them separate from main and open!
...
- Datastore persistence: see [Data Persistence][lecture-datastore]
- Accessibility: see [Accessibility][lecture-accessibility]
- Kotlin functional manipulation / extensions / generics : see [Advanced Kotlin][lecture-advanced-kotlin]
- Kotlin coroutines: see [Kotin coroutines][lecture-coroutines] and [ViewModel, StateFlow, and Sideeffects][lecture-viewmodel]
...
- To see what your repository should look like (and to see how each codelab starts), you can see [My example, partially-complete, Assignment 4 repository](https://github.com/michaelhaaf/5A6-F23-assignment4)
