...
[codelab-accessibility]: https://developer.android.com/codelabs/jetpack-compose-accessibility#0
...
- (Required): [Accessibility in Jetpack Compose][codelab-accessibility] (~40mins)
...
- (Option 2): Complete both of the following (~45 mins total):
