...
- You may also make use of the lambda example code that I wrote in class on Friday Sep 1. I have uploaded the code to an [online interactive REPL](https://pl.kotl.in/CYJmoZj7o?theme=darcula), you can also [download the code directly to your machine](/code/sep1-lambda-eg/calculator.kt).


## Requirements

- Use a [data class](/lectures/programming/02-oop-in-kotlin/#data-classes) to store at least three pieces of information about a `Person`:
  - **one `String`**
  - **one `Int`**
  - **one [Nullable type](/lectures/programming/02-oop-in-kotlin/#null-safety) of your choice** 
...
- The `.zip` that you hand-in to Moodle should contain:
  ...
  - A README.md or README.txt (NOT .docx, .pdf, or any other format) containing instructions for building and running your code.
    - see the [Using Kotlin](/lectures/programming/04-using-kotlin) lecture notes for more details about how to compile/run/build Kotlin in various editors/platforms.
