...
Single screen Kotlin / Compose Multiplatform App

For this assignment, you will create a single screen mobile app that runs on one platform (iOS or Android), and uses the multiplatform technologies taught in class. The topic of the app is of your choice
...
## Submission
Submit zip file of entire project on Moodle.
